        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {DESTINATIONS_DATA.map((dest) => (
            <div
              ...
              className="group relative h-96 rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1.5 cursor-pointer border border-slate-200"
            >
              {/* Image */}
              <img
                src={dest.image}
              ...
              {/* Starting Price Pill */}
              <div className="absolute top-4 right-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-xs font-black px-3 py-1 rounded-full shadow-md">
              ...
              <div className="absolute bottom-0 inset-x-0 p-6 flex flex-col justify-end text-white">
                ...
                <h3 className="text-2xl font-black font-display text-white group-hover:text-amber-200 transition-colors">
                  {dest.name}
                </h3>
                ...
                {/* Explore Link */}
                <div className="mt-4 pt-3 border-t border-white/20 flex items-center justify-between text-xs font-bold text-teal-300 group-hover:text-white transition-colors">
                  <span>Explore Destination</span>
                  <div className="w-7 h-7 rounded-full bg-white/20 group-hover:bg-teal-500 flex items-center justify-center transition-colors">
